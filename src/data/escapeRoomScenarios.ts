...
function generateRemainingScenarios(): EscapeScenario[] {
  ...
  const cytologyScenarios: { id: number; title: string; theme: string; diff: EscapeScenario["difficulty"]; time: number; puzzles: Puzzle[] }[] = [
    ...
    { id: 116, title: "RER e REL — Fábricas Celulares", theme: "Citologia", diff: "Médio", time: 90, puzzles: [
      { type: "multiple_choice", question: "O RER é especializado na síntese de:", options: ["Lipídios e esteroides", "Proteínas de exportação, lisossomais e de membrana", "ATP", "Glicogênio"], correctAnswer: 1, explanation: "RER: ribossomos → síntese proteica de exportação, membrana e lisossomal. Peptídeo-sinal → SRP → translocon Sec61." },
      { type: "fill_blank", question: "A ___ inicia-se no RER, adicionando oligossacarídeo ao resíduo de asparagina.", correctAnswer: "N-glicosilação", explanation: "N-glicosilação: oligossacarídeo do dolicol → Asn (sequência Asn-X-Ser/Thr). Modificada depois no Golgi.", options: ["O-glicosilação", "N-glicosilação", "fosforilação", "ubiquitinação"] },
      { type: "true_false", question: "O REL é abundante em hepatócitos por seu papel na desintoxicação via citocromo P450.", correctAnswer: "Verdadeiro", explanation: "O REL hepático contém enzimas do sistema P450: metaboliza fármacos, toxinas e álcool. Pode hipertrofiar com uso crônico." },
      { type: "multiple_choice", question: "Os corpúsculos de Nissl nos neurônios correspondem a:", options: ["Mitocôndrias", "RER + polirribossomos livres", "Complexo de Golgi", "Lisossomos"], correctAnswer: 1, explanation: "Nissl = RER + polirribossomos livres (basófilos à H&E). Ausentes no cone axonal e axônio. Presentes no pericário e dendritos." },
      { type: "true_false", question: "O retículo sarcoplasmático é uma forma especializada de REL.", correctAnswer: "Verdadeiro", explanation: "O RS armazena Ca²⁺ no músculo. Liberação de Ca²⁺ → contração. SERCA (Ca²⁺-ATPase) recapta Ca²⁺ → relaxamento." },
    ]},
    { id: 117, title: "Defeitos de Membrana e Doenças", theme: "Citologia", diff: "Difícil", time: 120, puzzles: [
      { type: "multiple_choice", question: "Na esferocitose hereditária, o defeito mais comum envolve:", options: ["Hemoglobina S", "Anquirina/espectrina do citoesqueleto eritrocitário", "Glicose-6-fosfato desidrogenase", "Canal CFTR"], correctAnswer: 1, explanation: "Anquirina (~60% dos casos): ancora espectrina à banda 3. Defeito → perda de membrana → esferócitos → hemólise no baço." },
      { type: "fill_blank", question: "A ___ paroxística noturna resulta de defeito na âncora GPI.", correctAnswer: "hemoglobinúria", explanation: "HPN: mutação somática no gene PIG-A → sem âncora GPI → ausência de CD55/CD59 → lise pelo complemento.", options: ["hemoglobinúria", "hematúria", "proteinúria", "glicosúria"] },
      { type: "true_false", question: "A fibrose cística é causada por defeito no canal de sódio ENaC.", correctAnswer: "Falso", explanation: "FC: defeito no CFTR (canal de Cl⁻). Mutação mais comum: ΔF508. Muco espesso → infecções pulmonares e insuficiência pancreática." },
      { type: "multiple_choice", question: "Na hipercolesterolemia familiar, o defeito está no:", options: ["Canal de Ca²⁺", "Receptor de LDL (endocitose mediada por clatrina)", "Transportador GLUT4", "Receptor de insulina"], correctAnswer: 1, explanation: "Defeito no receptor de LDL → LDL não é internalizado → hipercolesterolemia → aterosclerose precoce. Exemplo clássico de endocitose mediada por receptor." },
      { type: "true_false", question: "A ouabaína é um inibidor da bomba Na⁺/K⁺-ATPase.", correctAnswer: "Verdadeiro", explanation: "Digitálicos (ouabaína, digoxina) inibem Na⁺/K⁺-ATPase → ↑Na⁺ intracelular → ↑Ca²⁺ via trocador Na⁺/Ca²⁺ → maior contratilidade cardíaca." },
    ]},
    { id: 118, title: "Tráfego Vesicular e SNAREs", theme: "Citologia", diff: "Difícil", time: 120, puzzles: [
      { type: "multiple_choice", question: "A toxina botulínica causa paralisia flácida porque:", options: ["Bloqueia receptores de acetilcolina", "Cliva proteínas SNARE → impede liberação de ACh", "Destrói neurônios motores", "Inibe a síntese de ACh"], correctAnswer: 1, explanation: "Botulínica: metaloprotease que cliva VAMP/sinaptobrevina e SNAP-25 → vesículas sinápticas não fundem com a membrana → sem liberação de ACh." },
      { type: "fill_blank", question: "A ___ é a GTPase responsável pela clivagem do pescoço da vesícula endocítica revestida por clatrina.", correctAnswer: "dinamina", explanation: "Dinamina: GTPase mecânica que forma anel ao redor do pescoço da fosseta → hidrólise de GTP → clivagem → vesícula se separa da membrana.", options: ["Rab", "Ran", "dinamina", "Ras"] },
      { type: "true_false", question: "A toxina tetânica cliva as mesmas SNAREs que a botulínica mas em neurônios inibitórios.", correctAnswer: "Verdadeiro", explanation: "Tetânica: cliva sinaptobrevina em interneurônios inibitórios (Renshaw) → desinibição → espasmo/paralisia espástica (oposto da botulínica)." },
      { type: "multiple_choice", question: "As proteínas Rab são:", options: ["Canais iônicos", "GTPases que regulam especificidade do tráfego vesicular", "Proteínas de membrana nuclear", "Enzimas lisossômicas"], correctAnswer: 1, explanation: "~60 Rab-GTPases: cada compartimento tem Rabs específicos. Rab5 (endossomo precoce), Rab7 (endossomo tardio), Rab11 (reciclagem)." },
      { type: "order", question: "Ordene o tráfego de uma enzima lisossômica: RER → Golgi → Endossomo tardio → Lisossomo", correctAnswer: "RER,Golgi,Endossomo tardio,Lisossomo", explanation: "Síntese no RER → N-glicosilação → Golgi (M6P) → TGN (receptor M6P + clatrina) → endossomo tardio → lisossomo." },
    ]},
    { id: 119, title: "Doenças de Depósito — Diagnóstico Diferencial", theme: "Citologia", diff: "Extremo", time: 120, puzzles: [
      { type: "multiple_choice", question: "A mancha vermelho-cereja na retina é achado clássico de:", options: ["Gaucher", "Tay-Sachs e Niemann-Pick A", "Fabry", "Pompe"], correctAnswer: 1, explanation: "Acúmulo gangliosídico/esfingolipídico nas células ganglionares da retina → palidez retiniana com fóvea normal (vermelho-cereja)." },
      { type: "fill_blank", question: "Na doença de Fabry, o substrato acumulado é o ___, devido à deficiência de α-galactosidase A.", correctAnswer: "globotriaosilceramida (Gb3)", explanation: "Fabry: ligada ao X. Gb3 acumula em endotélio, rins, coração. Angioqueratomas, acroparestesias, nefropatia.", options: ["glicocerebrosídeo", "esfingomielina", "globotriaosilceramida (Gb3)", "gangliosídeo GM2"] },
      { type: "true_false", question: "A doença de Pompe afeta primariamente o sistema nervoso central.", correctAnswer: "Falso", explanation: "Pompe: deficiência de maltase ácida → acúmulo de glicogênio nos LISOSSOMOS → cardiomiopatia hipertrófica, miopatia. Forma infantil: cardiomegalia." },
      { type: "multiple_choice", question: "Os macrófagos com aspecto de 'papel amassado' são patognomônicos de:", options: ["Niemann-Pick", "Tay-Sachs", "Gaucher", "I-cell disease"], correctAnswer: 2, explanation: "Macrófagos de Gaucher: citoplasma fibrilar/estriado (papel amassado) pelo acúmulo de glicocerebrosídeo em lisossomos tubulares." },
      { type: "fill_blank", question: "As 'células espumosas' com acúmulo de esfingomielina são características da doença de ___.", correctAnswer: "Niemann-Pick", explanation: "Niemann-Pick A/B: deficiência de esfingomielinase ácida → macrófagos espumosos (mar azul) no baço, fígado, MO e pulmão.", options: ["Gaucher", "Niemann-Pick", "Fabry", "Krabbe"] },
    ]},
    { id: 120, title: "Ribossomos e Síntese Proteica", theme: "Citologia", diff: "Fácil", time: 60, puzzles: [
      { type: "multiple_choice", question: "Os ribossomos eucarióticos são:", options: ["70S (30S + 50S)", "80S (40S + 60S)", "90S (45S + 45S)", "100S (50S + 50S)"], correctAnswer: 1, explanation: "Eucarióticos: 80S = 40S (18S rRNA) + 60S (28S, 5.8S, 5S rRNA). Procarióticos/mitocôndrias: 70S." },
      { type: "true_false", question: "A atividade de peptidil-transferase é catalisada por proteínas ribossômicas.", correctAnswer: "Falso", explanation: "A peptidil-transferase é uma RIBOZIMA: o rRNA 28S da subunidade 60S catalisa a ligação peptídica (RNA catalítico)." },
      { type: "fill_blank", question: "Ribossomos livres no citoplasma sintetizam proteínas ___.", correctAnswer: "citoplasmáticas e nucleares", explanation: "Livres: proteínas do citosol, núcleo, mitocôndria, peroxissomos. RER-aderidos: exportação, membrana, lisossomais.", options: ["de secreção", "citoplasmáticas e nucleares", "mitocondriais exclusivamente", "lisossômicas"] },
      { type: "multiple_choice", question: "Os polissomos (polirribossomos) são:", options: ["Ribossomos dentro do núcleo", "Múltiplos ribossomos traduzindo simultaneamente o mesmo mRNA", "Ribossomos mitocondriais", "Subunidades ribossômicas livres"], correctAnswer: 1, explanation: "Polissomos: vários ribossomos percorrem um mesmo mRNA → múltiplas cópias da proteína simultaneamente → eficiência." },
      { type: "true_false", question: "Antibióticos como eritromicina e cloranfenicol atuam nos ribossomos 70S bacterianos.", correctAnswer: "Verdadeiro", explanation: "Esses antibióticos inibem ribossomos 70S (procariotos) sem afetar os 80S humanos. Cloranfenicol: 50S. Tetraciclina: 30S." },
    ]},
  ];
