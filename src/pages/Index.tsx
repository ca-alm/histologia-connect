...
const summaries = [
  {
    ...
    content: [
      ...
      "As especializações de membrana incluem microvilosidades (aumentam absorção), cílios (movimentam substâncias), e estereocílios (absorção no epidídimo). A lâmina basal é uma estrutura extracelular que ancora o epitélio ao tecido conjuntivo subjacente.",
      "As junções celulares (tight junctions, desmossomos, gap junctions) garantem coesão e comunicação intercelular, sendo fundamentais para a função de barreira epitelial.",
    ],
  },
  {
    icon: "🧬",
    ...
    content: [
      ...
      "As células residentes incluem fibroblastos (síntese de matriz), macrófagos (fagocitose), mastócitos (mediadores inflamatórios), e adipócitos (armazenamento energético).",
      "Os tipos especializados incluem tecido adiposo (unilocular e multilocular), cartilaginoso (hialina, elástica, fibrosa) e ósseo (compacto e esponjoso), cada um com funções específicas.",
    ],
  },
  {
    icon: "💪",
    ...
    content: [
      ...
      "O músculo cardíaco possui células ramificadas com núcleo central e discos intercalares contendo gap junctions, permitindo a contração sincronizada. É involuntário e auto-rítmico.",
      "O músculo liso apresenta células fusiformes com núcleo central, sem estriações visíveis. Está presente em vísceras e vasos sanguíneos, com contração lenta e sustentada.",
    ],
  },
  {
    icon: "🧠",
    ...
    content: [
      "Os neurônios são as unidades funcionais do sistema nervoso, compostos por corpo celular (pericário), dendritos e axônio. São classificados em multipolares, bipolares e pseudounipolares.",
      "As células da glia incluem astrócitos (suporte e barreira hematoencefálica), oligodendrócitos (mielina no SNC), células de Schwann (mielina no SNP), microglia (defesa) e células ependimárias (revestimento ventricular).",
      "As sinapses podem ser químicas (neurotransmissores) ou elétricas (gap junctions). A bainha de mielina aumenta a velocidade de condução nervosa através da condução saltatória nos nodos de Ranvier.",
    ],
  },
  {
    icon: "🩸",
    ...
    content: [
      "O sangue é um tecido conjuntivo especializado composto por plasma e elementos figurados: eritrócitos (transporte de O₂), leucócitos (defesa) e plaquetas (hemostasia).",
      "Os leucócitos são divididos em granulócitos (neutrófilos, eosinófilos, basófilos) e agranulócitos (linfócitos, monócitos). Cada tipo tem funções específicas na resposta imune.",
      "A hematopoiese ocorre na medula óssea vermelha a partir de células-tronco hematopoiéticas pluripotentes que se diferenciam nas linhagens mieloide e linfoide.",
    ],
  },
];
